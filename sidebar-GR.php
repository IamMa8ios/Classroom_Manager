...
<nav class="sidebar rounded-right">
    <div class="sidebar-header text-center">
        <a href="index-gr.php" class="text-wrap text-capitalize text-center fw-bold"><img src="img/img-logo.png" alt="aegean"
class="img-fluid mx-auto d-block object-fit-cover w-100 rounded-3">Πρόγραμμα Αιθουσών<br>ΑΡΧΙΚΗ</a>
    </div>
                    ...
                    <?php foreach ($classes as $class) { ?>
                        ...
                        <li class="sidebar-li px-2 my-3">
                            ...
                            <?php if ($_SESSION['role'] > 2) { ?>
                                <form action="manage-classroom-gr.php" method="post">
    ...
    <?php if ($_SESSION['role'] > 1) { ?>
        <ul class="list-unstyled">
            <?php if ($_SESSION['role'] > 2) { ?>
                <li class="sidebar-li px-2 my-3">
                    <a class="btn rounded-4" href="manage-classroom-gr.php">Νέα Αίθουσα</a>
                </li>
            <?php } ?>
            <li class="sidebar-li px-2 my-3">
                <a class="btn rounded-4" href="user-dashboard-gr.php">Το Ταμπλό μου</a>
            </li>
        </ul>
    <?php } ?>
</nav>
