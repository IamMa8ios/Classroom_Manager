                    ...
                    <div class="row g-3 my-3">
                        ...
                        <div class="col-md-6">
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control" value="<?php echo $building; ?>" id="building" required>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row g-3 my-3">
                        <div class="col-md-6">
                            <div class="input-group">
                                ...
                                <input type="time" class="form-control" name="startTime" id="startTime" min="09:00:00" max="20:00:00" required>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="input-group">
                                <label class="input-group-text" for="endTime">Available Until</label>
                                <input type="time" class="form-control" name="endTime" id="endTime" min="10:00:00" max="21:00:00" required>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row g-3 my-3">
                        <div class="col-md-6">
                            <div class="input-group">
                                ...
                                <input type="number" class="form-control" name="capacity" id="capacity" min="5" max="150" step="1" required>
                            </div>
                        </div>
                    ...
                    <div class="row g-3 my-3 daysOfWeek">
                        <div class="col-md-6">
                            <div class="form-check form-switch my-3">
                                <label class="form-check-label" for="type">Theory</label>
                                <input class="form-check-input" type="checkbox" role="switch" id="type" checked>
                                <label class="form-check-label" for="type">Lab</label>
                            </div>
