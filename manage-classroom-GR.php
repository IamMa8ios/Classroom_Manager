        ...
        <div class="container mt-5 p-3 bg-purple-svg" id="create-event-container">
            <form id="create_class_form" action="manage_class_script.php" method="post">
                ...
                <div class="row g-3 my-3">
                    ...
                    <div class="col-md-6">
                        <div class="input-group">
                            <label class="input-group-text" for="building">Κτήριο</label>
                ...
                <div class="row g-3 my-3">
                    <div class="col-md-6">
                        <div class="input-group">
                            <label class="input-group-text" for="startTime">Διαθέσιμη Απο</label>
                    ...
                    <div class="col-md-6">
                        <div class="input-group">
                            <label class="input-group-text" for="endTime">Διαθέσιμη Μέχρι</label>
                ...
                <div class="row g-3 my-3">
                    <div class="col-md-6">
                        <div class="input-group">
                            <label class="input-group-text" for="capacity">Χωρητικότητα</label>
                    ...
                    <div class="col-md-3 daysOfWeek">
                        <div class="form-check my-3">
                            ...
                            <label class="form-check-label" for="projector">Προβολέας</label>
                        </div>
                    </div>
                    <div class="col-md-3 daysOfWeek">
                        <div class="form-check my-3">
                            ...
                            <label class="form-check-label" for="locked">Κλειδωμένη</label>
                        </div>
                    </div>
                </div>
                ...
                <div class="row g-3 daysOfWeek">
                    <div class="col-md-12">
                        <div class="form-check">
                            ...
                            <label class="form-check-label" for="monday">Δευτέρα</label>
                        </div>
                    </div>
                    <div class="col-md-12">
                        <div class="form-check">
                            ...
                            <label class="form-check-label" for="tuesday">Τρίτη</label>
                        </div>
                    </div>
                    <div class="col-md-12">
                        <div class="form-check">
                            ...
                            <label class="form-check-label" for="wednesday">Τετάρτη</label>
                        </div>
                    </div>
                    <div class="col-md-12">
                        <div class="form-check">
                            ...
                            <label class="form-check-label" for="thursday">Πέμπτη</label>
                        </div>
                    </div>
                    <div class="col-md-12">
                        <div class="form-check">
                            ...
                            <label class="form-check-label" for="friday">Παρασκευή</label>
                        </div>
                    </div>
                </div>
                ...
                <div class="row g-3 my-3">
                    <div class="col-md-6">
                        <input class="lab-switch" type="checkbox" id="lab-switch-toggle" <?php if(isset($classData) && $classData['type'] == 0) echo 'checked';?>
                               onclick="handleLabTheorySwitch('lab-switch-toggle','lab-capacity')" data-theory="Θεωρία"
                               data-lab="Εργαστήριο">
                    </div>

                    <div class="col-md-6">
                        <div class="input-group visually-hidden" id="lab-capacity">
                            <label class="input-group-text" for="computers">Αριθμός Υπολογιστών</label>
                        ...
                        <div class="col">
                            <?php if(isset($_POST['edit'])){ ?>
                                ...
                                <button class="btn btn-secondary btn-not" name="delete" title="Delete"
                                        value="<?php echo $_POST['edit']; ?>">Διαγραφή <i class="fas fa-trash-alt"></i>

                                </button>
                            <?php } ?>
                            <button type="button" class="btn btn-secondary btn-not" onclick="clearClassForm()">Εκκαθάριση <i
                                        class="fas fa-eraser"></i></button>
                            <button type="submit" class="btn btn-primary"
                                    name="<?php echo isset($_POST['edit'])?'edit':'create'; ?>"
                                    value="<?php if(isset($_POST['edit'])) echo $_POST['edit']; ?>">
                                Υποβολή <i class="far fa-check-circle"></i></button>
                        </div>
                    </div>
            </form>
        </div>
