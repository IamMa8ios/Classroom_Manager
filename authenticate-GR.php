            ...
            <div class="row full-height justify-content-center">
                <div class="col-12 text-center align-self-center py-5">
                    <div class="section pb-5 pt-5 pt-sm-2 text-center">
                        <h6 class="mb-0 pb-3"><span>Είσοδος </span><span>Εγγραφή</span></h6>
                                    ...
                                    <div class="center-wrap">
                                        <div class="section text-center">
                                            ...
                                            <form action="authenticate-EN.php" method="post">
                                                ...
                                                <button name="login" value="login" class="btn mt-4">Υποβολή</button>
                                                <a href="index-EN.php" class="btn mt-4"><i class="fas fa-long-arrow-alt-left mx-2"></i>Πισω</a>
                                                <p class="mb-0 mt-4 text-center"><a href="#0" class="link">Ξεχάσατε τον κωδικό;</a></p>
                                            </form>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="center-wrap">
                                        <div class="section text-center">
                                            ...
                                            <form action="authenticate-EN.php" method="post">
                                                ...
                                                <button name="register" value="register" class="btn mt-4" type="submit">Υποβολή</button>
                                                <a href="index-EN.php" class="btn mt-4"><i class="fas fa-long-arrow-alt-left mx-2"></i>Πίσω</a>
                                            </form>
                                        </div>
                                    </div>
                                </div>
