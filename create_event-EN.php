                    ...
                    <div class="row g-3 my-3">
                        ...
                        <div class="col-md-6">
                            <div class="input-group">
                                ...
                                <input type="date" class="form-control" name="endDate" value="<?php echo $endDate; ?>" id="endDate">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row g-3 my-3">
                        ...
                        <div class="col-md-6">
                            <div class="input-group">
                                ...
                                <input type="number" class="form-control" name="duration" value="<?php echo $duration; ?>" id="duration" min="1" max="3"
                                       step="0.5" required>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-check my-3">
                                <input class="form-check-input" type="checkbox" name="recurring" value=""
                                       id="recurring">
                                <label class="form-check-label" for="recurring" <?php if(isset($event['repeatable']) && $event['repeatable']) echo "checked"; ?> >Recurring</label>
                            </div>
                        </div>
                    </div>
            ...
            <div class="container mt-5 bg-purple-svg" id="create-recoupment-container">
                <form id="recoupment_form" action="create_recoupment_script.php" method="post">
                    ...
                    <div class="row g-3 my-3 bg-purple-svg visually-hidden" id="recoupment-fields">
                        ...
                        <div class="row my-3">
                            <div class="col-md-6">
                                <button type="button" class="btn btn-secondary btn-not" onclick="clearRecoupmentForm()">
                                    Clear <i
                                            class="fas fa-eraser"></i></button>
