                ...
                <div class="row g-3 my-3">
                    <div class="col-md-6">
                        <div class="form-check my-3">
                            <input class="form-check-input" type="checkbox" id="create-event" onclick="handleLabTheorySwitch('create-event','create-event-fields')">
                ...
                <div class="row g-3 my-3 bg-purple-svg visually-hidden" id="recoupment-fields">
                    ...
                    <div class="col-md-6 my-3">
                        <div class="input-group">
                            ...
                            <input type="date" class="form-control" name="recoupment-date" value="" id="recoupment-date" required readonly>
                        </div>
                    </div>
                    <div class="col-md-6 my-3">
                        <div class="input-group">
                    ...
                    <div class="col-md-6 my-3">
                        <div class="input-group">
                            ...
                            <input type="time" class="form-control" name="recoupment-time" id="recoupment-time" min="<?php echo $minStart; ?>" max="<?php echo $maxStart; ?>" required>
                        </div>
                    </div>
                    <div class="col-md-6 my-3">
                        <div class="input-group">
                            <label class="input-group-text" for="recoupment-duration">Recoupment Duration</label>
                            <input type="number" class="form-control" name="recoupment-duration" id="recoupment-duration" min="1" max="3" step="0.5" required>
                        </div>
                    </div>
