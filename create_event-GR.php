...
if ($_SESSION['role'] > 1) {
    ...
    if (isset($_GET['date'])) {
        ...
        $navTitle = "Δημιουργία Νέας Κράτησης";
        $formTitle = "Νέο Event";
...
//                echo $lecture['id']==$event['lectureID']?"matched":"not matched";
        ...
        $action="edit";
        $navTitle = "Επεξεργασία Κράτησης";
        $formTitle = "Επεξεργασία Κράτησης";
                                    ...
                                    <form id="create_event_form" action="create_event_script.php" method="post">
                                        ...
                                        <div class="row g-3 my-3">
                                            <div class="col-md-6">
                                                <div class="input-group">
                                                    <label class="input-group-text" for="className">Αίθουσα</label>
                                            ...
                                            <div class="col-md-6">
                                                <div class="input-group">
                                                    <label class="input-group-text" for="lectures">Διαλέξεις</label>
                                        ...
                                        <div class="row g-3 my-3 daysOfWeek">
                                            <?php if (isset($_GET['eventID']) && $_SESSION['role'] == 3) { ?>
                                                <div class="col-md-6">
                                                    <div class="input-group">
                                                        <label class="input-group-text" for="userID">Διδάσκων</label>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-check my-3">
                                                    ...
                                                    <label class="form-check-label"
                                                           for="recurring" <?php if (isset($event['repeatable']) && $event['repeatable']) echo "checked"; ?> >Επαναλαμβανόμενη</label>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row my-3">
                                            <div class="col-md-6">
                                                <button type="button" class="btn btn-secondary btn-not" onclick="clearEventForm()">Εκκαθάριση
                                                    <i
                                                ...
                                                >Υποβολή <i class="far fa-check-circle"></i>
                                                </button>
                                            </div>
                                        </div>
                                    </form>
                                            ...
                                            <div class="row my-3">
                                                <div class="col">
                                                    <button type="button" class="btn btn-secondary btn-not"
                                                            onclick="clearEventFileForm()">Εκκαθάριση
                                                        <i
                                                                class="fas fa-eraser"></i></button>
                                                    <button type="submit" class="btn btn-primary">Υποβολή
                                    ...
                                    <form class="container p-2" id="recoupment_form" action="create_recoupment_script.php" method="post">
                                        <div class="row g-3 my-3 bg-purple-svg" id="recoupment-fields">
                                            ...
                                            <div class="col-md-6 my-3">
                                                <div class="input-group">
                                                    <label class="input-group-text" for="recoupment-date">Ημερομηνία</label>
                                            ...
                                            <div class="col-md-6">
                                                <div class="input-group">
                                                    <label class="input-group-text" for="initial-reservation">Αρχική Κράτηση</label>
                                            ...
                                            <div class="col-md-6 my-3">
                                                <div class="input-group">
                                                    <label class="input-group-text" for="date_lost">Ημερομηνία που Χάθηκε</label>
                                            ...
                                            <div class="col-md-6 my-3">
                                                <div class="input-group">
                                                    <label class="input-group-text" for="teacher">Διδάσκων</label>
                                            ...
                                            <div class="col-md-6 my-3">
                                                <div class="input-group">
                                                    <label class="input-group-text" for="start-time">Ημερομηνία Έναρξης</label>
